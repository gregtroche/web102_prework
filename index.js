...
const grammarGame = numUnfundedGames == 1 ? 'game remains' : 'games remain';
let templateString = `A total of $100,000 has been raised for 4 games. Currently, ${numUnfundedGames} ${grammarGame} unfunded. We need your help to fund these amazing games!`


// create a new DOM element containing the template string and append it to the description container
let pTag = document.createElement('p');
pTag.innerHTML = `${templateString}`
...
topGame.innerHTML = `<p>${first.name}</p>`;
